    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                 related_name='ore_tax', to='corptools.eveitemtype')),
            ],
        ),
        migrations.CreateModel(
            name='OrePrice',
            fields=[
                ...
                ('last_update', models.DateTimeField(auto_now=True)),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                 related_name='ore_price', to='corptools.eveitemtype')),
            ],
        ),
        migrations.CreateModel(
            name='MiningTax',
            fields=[
                ...
                ('flat_tax_rate', models.DecimalField(blank=True,
                ...
                ('tax_rate', models.ForeignKey(blank=True, default=None, null=True,
                 on_delete=django.db.models.deletion.CASCADE, to='moons.oretaxrates')),
            ],
        ),
    ]
